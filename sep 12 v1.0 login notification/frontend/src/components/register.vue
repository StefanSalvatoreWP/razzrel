  ...
  <div v-if="showTermsModal" class="modal">
    <div class="modal-content">
      ...
      <div class="terms-content">
        ...
        <p>By using Razz Rel Events, you agree to these Terms and Conditions.</p>

        <h3>Use of Service</h3>
        <p>You agree to use our service for lawful purposes only and in a way that does not infringe on others' rights.</p>

        <h3>User Account</h3>
        <p>You are responsible for maintaining the confidentiality of your account and password.</p>

        <h3>Privacy Policy</h3>
        <p>Your use of Razz Rel Events is also governed by our Privacy Policy.</p>

        <h3>Limitation of Liability</h3>
        <p>Razz Rel Events is not liable for any indirect, incidental, special, consequential or punitive damages.</p>
  ...
  try {
    ...
    if (result.success) {
      ...
      setTimeout(() => {
        ...
        emit("close"); // Close the modal after showing the notification
